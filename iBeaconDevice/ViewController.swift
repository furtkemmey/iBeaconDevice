...
//        peripheral.delegate = self  //<--可能是多餘的程式
        ...
        let region = CLBeaconRegion(proximityUUID: uuid!, major: 20000, minor: 499, identifier: "")
        //取得iBeacon裝置要廣播的字典物件
        var dic = region.peripheralData(withMeasuredPower: nil) as Dictionary
        dic.updateValue("這是模擬的iBeacon裝置499" as AnyObject, forKey: CBAdvertisementDataLocalNameKey as NSObject)
        //開始廣播訊號
